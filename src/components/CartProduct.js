...
export default function CartProduct({ product }) {
  ...
  return (
    <div className="flex justify-between space-x-4 hover:shadow-lg hover:border-opacity-50 border border-opacity-0  rounded-md p-4 ">
      <Link
      ...
      <div className="flex items-center">
        <div className="flex items-center space-x-3">
          ...
          <p className="font-semibold text-x1">{product.quantity}</p>
          <button
            onClick={() => setItemQuantity(product.id, product.quantity + 1)}
