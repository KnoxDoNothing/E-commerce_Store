  ...
  return (
    <>
      <div className="container xl:max-w-screen-xl mx-auto py-12 px-6 text-center">
        {error ? (
          <div className="p-2 rounded-md bg-rose-100 text-red-500 max-w-md mx-auto">
            ...
            <div className="p-2 rounded-md text-gray-500 max-w-md mx-auto">
              ...
              <div className=" py-4 px-8 space-y-4 rounded-md max-w-lg mx-auto">
                ...
                <h2 className="text-4xl font-semibold flex flex-col items-center space-x-1">Thanks for your order!</h2>
                <p className="text-lg">
